        ...
        case 1:
            {
                k++; if (k < 9)
                {
                    ...
                    mas[k, 0] = Console.ReadLine()!; Console.Write("Введите дату:");
                    mas[k, 1] = Console.ReadLine()!; Console.Write("Введите время:");
                    mas[k, 2] = Console.ReadLine()!; Console.Write("Введите приоритет:");
